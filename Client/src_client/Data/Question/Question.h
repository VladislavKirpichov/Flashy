...
class Question{
public:
    Question(): question_id(0), mark(0){}
    Question(const std::string& _page_id ): question_id(0), mark(0), page_id(_page_id){}
    unsigned int get_question_id(){return question_id;}
    std::string get_page_id(){return page_id;}
    std::string get_title(){return title;}
    std::string get_answer(){return answer;}
    bool is_liked(){return mark==1;}
    void set_question_id(const unsigned int &new_id){question_id = new_id;}
